...
public class HomeVendor {
	public Scene getScene() {
        ...
        Button manageVendors = new Button("Manage Product");
        manageVendors.setPrefWidth(400);
        manageVendors.setPrefHeight(200);
        ...
        manageVendors.setOnAction(event -> {
        	PageManager.getInstance().showViewManageProduct(UserSession.getInstance().getCurrUser().getUser_id());
        });

		// Font
        manageInvitations.setFont(Font.font("Arial", FontWeight.NORMAL, 16));
        manageVendors.setFont(Font.font("Arial", FontWeight.NORMAL, 16));
        ...
        gridContainer.add(manageVendors, 1, 0);
